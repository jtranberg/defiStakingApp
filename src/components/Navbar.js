...
class Navbar extends Component {
    render() {
        return (
            ...
            <nav className='navbar navbar-dark fixed-top shadow p-0' style={{backgroundColor:'#397375', height:'50px'}}>
                ...
                <ul className='navbar-nav px-3'>
                    <li className='text-nowrap d-none nav-item d-sm-none d-sm-block'>
                        <small style={{color:'#03fcd7'}}>ACCOUNT NUMBER: {this.props.account}
                        </small>
                    </li>
                </ul>
            </nav>
